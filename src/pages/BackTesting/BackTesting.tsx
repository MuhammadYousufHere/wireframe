      ...
      <div className="backtesting">
        <div className="backtesting__content">
          ...
          <div className="row">
            ...
            <Input type="text" label="EMA" placeholder="200" />
            <Input type="text" label="ATR" placeholder="14" />
            <Input type="text" label="ADX" placeholder="14" />
            <Input type="text" label="ADX threshold" placeholder="14" />
            <Input
              type="text"
              Icon={<AiOutlinePercentage />}
              label="Risk size"
